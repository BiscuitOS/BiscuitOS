...
echo 'INS_PATH    := $(ROOT)/rootfs/rootfs/' >> ${MF}
...
[ ${UBUNTU}X = "22X" ] && echo "CONFIG    += --python=/usr/bin/python3" >> ${MF}
echo '' >> ${MF}
echo '' >> ${MF}
echo 'all:' >> ${MF}
echo -e '\t@cd $(BASENAME) ; \' >> ${MF}
echo -e '\tmeson compile -C build;' >> ${MF}
...
echo 'install:' >> ${MF}
echo -e '\t@cd $(BASENAME) ; \' >> ${MF}
echo -e '\tsudo meson install --destdir=$(INS_PATH)/ -C build ; \' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libuuid.so.* $(INS_PATH)/usr/lib/ ;' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libjson-c.so* $(INS_PATH)/usr/lib/ ;' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libtraceevent.so* $(INS_PATH)/usr/lib/ ;' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libtracefs.so* $(INS_PATH)/usr/lib/ ;' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libkmod.so* $(INS_PATH)/usr/lib/ ;' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libudev.so* $(INS_PATH)/usr/lib/ ;' >> ${MF}
echo -e '\tsudo cp /lib/x86_64-linux-gnu/libzstd.so* $(INS_PATH)/usr/lib/ ;' >> ${MF}
