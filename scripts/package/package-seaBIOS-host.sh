...
echo -e '\t@if [ -f $(BASENAME)/BiscuitOS-pipe ]; then \' >> ${MF}
echo -e '\t\trm -rf $(BASENAME)/BiscuitOS-pipe ; \' >> ${MF}
echo -e '\tfi ; \' >> ${MF}
echo -e '\tmkfifo $(BASENAME)/BiscuitOS-pipe ; \' >> ${MF}
echo -e '\tpython $(BASENAME)/scripts/readserial.py -nf $(BASENAME)/BiscuitOS-pipe' >> ${MF}
echo '' >> ${MF}
echo 'prepare:' >> ${MF}
...
echo '' >> ${MF}
echo 'download:' >> ${MF}
echo -e '\tln -s $(ROOT)/qemu-system/qemu-system/roms/seabios $(BASENAME)' >> ${MF}
echo -e '\t@if [ "${BS_SILENCE}X" != "trueX" ]; then \' >> ${MF}
echo -e '\t\tfiglet "BiscuitOS" ; \' >> ${MF}
echo -e '\tfi' >> ${MF}
...
echo '```' >> ${MF}
echo '' >> ${MF}
echo '5. menuconfig' >> ${MF}
echo '' >> ${MF}
echo '```' >> ${MF}
echo 'make menuconfig' >> ${MF}
echo '' >> ${MF}
echo '   Debugging  --->' >> ${MF}
echo '     (1) Debug level' >> ${MF}
echo '```' >> ${MF}
echo '' >> ${MF}
echo '5. Compile' >> ${MF}
echo '' >> ${MF}
