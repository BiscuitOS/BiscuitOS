...
echo -e '\t[ -f version.c ] && rm version.c ; \' >> ${MF}
echo -e '\tmake -j8; \' >> ${MF}
...
echo '' >> ${MF}
echo 'install:' >> ${MF}
echo -e '\tchmod 755 RunBiscuitOS.sh ; \' >> ${MF}
echo -e '\tsudo cp -rfa RunBiscuitOS.sh $(INS_PATH)/bin/ ; \' >> ${MF}
echo -e '\tcd $(BASENAME) ; \' >> ${MF}
echo -e '\tsudo mkdir -p $(INS_PATH)/share/mce-inject ; \' >> ${MF}
echo -e '\tsudo cp -rfa test/* $(INS_PATH)/share/mce-inject/ ; \' >> ${MF}
echo -e '\tsudo make install destdir=$(ROOT)/rootfs/rootfs/' >> ${MF}
echo -e '\t@if [ "${BS_SILENCE}X" != "trueX" ]; then \' >> ${MF}
echo -e '\t\tfiglet "BiscuitOS" ; \' >> ${MF}
echo -e '\tfi' >> ${MF}
...
echo '#/bin/ash' >> ${MF}
echo '# Enable CONFIG_X86_MCELOG_LEGACY & CONFIG_X86_MCE_INJECT' >> ${MF}
echo 'mce-inject /usr/share/mce-inject/corrected' >> ${MF}
echo 'mcelog' >> ${MF}
