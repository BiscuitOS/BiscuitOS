...
echo '' >> ${MF}
echo 'install:' >> ${MF}
echo -e '\t@sudo cp -rfa /usr/bin/ndctl $(INS_PATH)/bin' >> ${MF}
echo -e '\t@sudo cp -rfa /lib/x86_64-linux-gnu/libndctl.so* $(INS_PATH)/lib' >> ${MF}
echo -e '\t@sudo cp -rfa /lib/x86_64-linux-gnu/libdaxctl.so* $(INS_PATH)/lib' >> ${MF}
echo -e '\t@sudo cp -rfa /lib/x86_64-linux-gnu/libjson-c.so* $(INS_PATH)/lib' >> ${MF}
echo -e '\t@sudo cp -rfa /lib/x86_64-linux-gnu/libkeyutils.so* $(INS_PATH)/lib' >> ${MF}
echo -e '\t@sudo cp -rfa /lib/x86_64-linux-gnu/libkmod.so* $(INS_PATH)/lib' >> ${MF}
echo -e '\t@sudo cp -rfa /lib/x86_64-linux-gnu/libzstd.so* $(INS_PATH)/lib' >> ${MF}
